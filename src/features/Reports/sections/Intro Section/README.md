...
- `ReportHeading variant="intro"` renders the serif H1. Other headings default to sans-serif H2; use `as="h3"` for deeper nesting. Font choice is independent of the heading size.
