...
export const reportMock = {
  context: {
    ...
    entities: {
      apta: { id: "apta", name: "Apta Agency", website: "https://apta.agency", avatarFallback: "AA" },
      superside: { id: "superside", name: "Superside", website: "https://superside.com", avatarFallback: "S" },
      curio: { id: "curio", name: "Curio Digital", website: "https://curiodigital.io", avatarFallback: "CD" },
      hlabs: { id: "hlabs", name: "Hlabs", website: "https://hlabs.co.uk", avatarFallback: "HL" },
      designstudio: { id: "designstudio", name: "DesignStudio", website: "https://designstudio.com", avatarFallback: "D" },
      brandfuel: { id: "brandfuel", name: "Brandfuel", website: "https://brandfuel.co", avatarFallback: "B" },
    },
